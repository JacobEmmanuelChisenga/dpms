                ...
                <form method="post" action="{{ route('drivers.store') }}" class="space-y-4">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="license_class" name="license_class" type="text" class="mt-1 block w-full" :value="old('license_class')" required />
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('drivers.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md text-sm text-gray-700">{{ __('Cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
